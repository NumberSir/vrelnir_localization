...
2. 如果游戏版本号发生破坏性更新：如 `0.4.1` => `0.4.2`, 或 `0.4` -> `0.5`，则汉化版本号重置，如：
   - `0.4.1.7-chs-alpha1.7.1` => `0.4.2.5-chs-alpha1.0.0`
3. 如果游戏版本号发生小修小补更新：如 `0.4.1.7` => `0.4.1.8`, 或 `0.4.2.0` => `0.4.2.5`，则汉化版本号第一位加一，如：
   - `0.4.2.0-chs-alpha1.0.0` => `0.4.2.5-chs-alpha2.0.0`
